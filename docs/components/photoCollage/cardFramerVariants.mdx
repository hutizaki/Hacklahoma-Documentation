...
- [Card.ts](../src/components/photoCollage/photoCollageComponents/Card.ts) - AnimationState enum
- [Main PhotoCollage Documentation](../photocollage) - Complete component guide
